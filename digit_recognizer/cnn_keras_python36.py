...
Author: galaxy24
Github: https://github.com/galaxy24/kaggle
'''
import numpy as np
import pandas as pd
...
# 数据路径
data_dir = 'C:\\Users\jerlin\PycharmProjects\kaggle\digit_recognizer'
...
submission.to_csv(os.path.join(data_dir, "output/Result_keras_CNN.csv"))
print('finished')